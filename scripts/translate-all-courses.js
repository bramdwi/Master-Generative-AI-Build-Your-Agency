...
const termMap = [
  ...
  [/\bStoryboarding & Shot Planning\b/g, 'Papan Cerita & Perencanaan Shot'],
  ...
  [/\bThe Idea → Script → Storyboard → Video → Voice → Music → Captions → Publish Pipeline\b/g, 'Pipeline Ide → Naskah → Papan Cerita → Video → Suara → Musik → Kaption → Publish'],
  [/\bBuilding a TikTok\/Reels Factory\b/g, 'Membangun Pabrik Konten TikTok & Reels'],
  [/\bBuilding a YouTube Shorts Factory\b/g, 'Membangun Pabrik Konten YouTube Shorts'],
  ...
  [/\bSelling Content-Factory Output as a Service\b/g, 'Menjual Layanan Pabrik Konten ke Klien'],
