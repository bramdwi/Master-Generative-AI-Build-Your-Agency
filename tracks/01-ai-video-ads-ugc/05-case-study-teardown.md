...
Pembongkaran memisahkan iklan ke dalam lima lapisan yang sama dari Modul 1 — Script, Avatar/Voice, Video, Captions, Export — dan menanyakan, untuk setiap lapisan, "pilihan apa yang dibuat di sini, dan mengapa hal itu penting?" Hal ini mengubah "iklan tersebut berkinerja baik" menjadi daftar keputusan yang dapat digunakan kembali, dan bukan hanya sekedar kesan belaka.
...
2. **Transkripsikan Script** dan petakan ke struktur Hook/Pitch/Proof/CTA dari Modul 1 — perhatikan apa yang membuat Hook berfungsi secara spesifik (pertanyaan/klaim/visual apa, dan mengapa ia menghentikan *scroll*).
3. **Perhatikan Avatar/Voice** — nada suara, usia/demografis yang sesuai dengan audiens produk, tingkat energi.
4. **Perhatikan struktur Videonya** — berapa banyak yang berbicara vs. B-roll, dan di mana pemotongan terjadi relatif terhadap ketukan Script.
5. **Perhatikan gaya Captions** — pengaturan waktu, penekanan (kata kunci yang dicetak tebal/disorot), apakah disinkronkan dengan ucapan.
...
Katakanlah Anda sedang mencari merek serum perawatan kulit dan ingin membongkarnya untuk membuka percakapan. Anda membuka **Meta Ad Library** (gratis, tidak perlu *login*) dan menelusuri halaman merek.

**Langkah 1 — sinyal umur panjang:** Satu iklan menampilkan "mulai berjalan 47 hari yang lalu" dengan 6 varian yang hampir identik (Script yang sama, pembuat berbeda). Berlangsung selama itu, dengan begitu banyak variannya, pertanda bahwa merek tersebut menemukan Script yang unggul dan sekarang sedang menguji pembuat/pengait untuk menentangnya — bukan menebak-nebak.

**Langkah 2 — Script dipetakan ke struktur:**

| Lapisan | Apa yang sebenarnya ada di iklan |
| --- | --- |
| Hook (0-2 detik) | “Saya berhenti menggunakan retinol setelah hal ini terjadi pada kulit saya.” — pengait ketakutan/keingintahuan, belum merupakan klaim tentang produk |
| Pitch (2-12 detik) | Sebutkan keluhan spesifik (iritasi retinol) sebelum memperkenalkan produk sebagai alternatif |
| Proof (12-22 detik) | Sebelum/sesudah *close-up* kulit, diberi stempel waktu "hari 1 / hari 14" |
...
**Pengujian sebenarnya:** menjalankan klip GripMount Modul 1 melalui **`gemini-video-vision`** (muapi, $0,004/panggilan — model video-in, text-out) dengan perintah "pecahkan ini menjadi Hook/Pitch/Proof/CTA, dan komentari kualitas lip sync dan struktur video". Keluaran sebenarnya:
...
> **Lip sync:** "Luar biasa... tanpa cela dan selaras sempurna dengan audio."  
...
| Pendekatan | Pembongkaran manual | Dibantu AI (`gemini-video-vision`) |
| --- | --- | --- |
...
| Di mana bisa menyesatkan | Tidak berlaku — ini adalah bacaan Anda sendiri | Dapat melewatkan konteks yang dapat ditangkap oleh manusia (sejarah merek, norma kategori, alasan *khususnya* audiens) — perlakukan ini sebagai draf, bukan putusan |
...
2. **Sedang:** Hapus 3 iklan dalam kategori yang sama dan identifikasi persamaan di ketiga iklan tersebut (pola struktural yang sama) versus keunikan masing-masing iklan.
...
[← Sebelum: Penetapan Harga & Penjualan Iklan UGC](04-pricing-and-selling-ugc.md) · [Track overview](README.md) · Anda telah menyelesaikan Track 1 — lihat [ROADMAP.md](../../ROADMAP.md) untuk selanjutnya.
