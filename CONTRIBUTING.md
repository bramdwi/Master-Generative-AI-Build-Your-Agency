...
1. Copy the structure in [LESSON_TEMPLATEE.md](LESSON_TEMPLATEE.md) into a new `<NN>-<module-slug>.md` file directly under the track folder (`tracks/<NN>-<track-slug>/<NN>-<module-slug>.md`) — no per-module subfolder.
